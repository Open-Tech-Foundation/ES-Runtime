// Postgres QPS on Deno: postgres.js, pool of 100, 100 workers in flight.
import postgres from "postgres";
import { QPS_QUERY, QPS_ROWS, QPS_TOTAL, QPS_WORKERS, expectedSum } from "./qps-shared.mjs";

const WARMUP_S = Number(Deno.env.get("QPS_WARMUP") ?? 3);
const sql = postgres(Deno.env.get("PG_URL"), { prepare: true, fetch_types: false, max: 100 });
