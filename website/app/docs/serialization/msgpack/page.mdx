---
title: MessagePack
description: Native MessagePack encoding and decoding in runtime:serialization, backed by rmp-serde.
---

# MessagePack

MessagePack lives in `runtime:serialization` and runs in Rust, backed by
`rmp-serde` — bytes in, a JavaScript value out, with no npm package to add.
