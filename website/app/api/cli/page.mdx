...
Each of these is an error, because ignoring it would leave a run wider than the
command line claims:
...
| `esrun app.js --deny-net` | After the script it is the script's argument (`--` opts out) |
