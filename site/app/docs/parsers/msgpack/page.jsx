...
export default function MessagePackParserDoc() {
  return (
    <DocsShell active="/docs/parsers/msgpack">
      <p className="text-sm font-medium text-brand-600">Guides</p>
      <h1 className="mt-2 text-4xl font-bold tracking-tight text-zinc-900">
        MessagePack Processing
      </h1>
      <p className="mt-4 text-lg leading-relaxed text-zinc-600">
        ES-Runtime provides high-performance native MessagePack parsing via the <code className="rounded bg-zinc-100 px-1.5 py-0.5 text-[13px]">runtime:parsers</code> module, backed by <code className="rounded bg-zinc-100 px-1.5 py-0.5 text-[13px]">rmp-serde</code>.
      </p>
      ...
      <div className="mt-6">
        <CodeBlock code={`import { MessagePack } from "runtime:parsers";
