...
export default function TOMLParserDoc() {
  return (
    <DocsShell active="/docs/serialization/toml">
      <p className="text-sm font-medium text-brand-600">Guides</p>
      <h1 className="mt-2 text-4xl font-bold tracking-tight text-zinc-900">
        TOML Processing
      </h1>
      <p className="mt-4 text-lg leading-relaxed text-zinc-600">
        ES-Runtime provides high-performance native TOML parsing via the <code className="rounded bg-zinc-100 px-1.5 py-0.5 text-[13px]">runtime:serialization</code> module, backed by the fast <code className="rounded bg-zinc-100 px-1.5 py-0.5 text-[13px]">toml</code> rust crate.
      </p>
      ...
      <div className="mt-6">
        <CodeBlock code={`import { TOML } from "runtime:serialization";
